...
//                .andExpect(status().isOk());
    ...
    public void should_update_rs_event() throws Exception {
        ...
        mockMvc.perform(patch("/rs/update?index=2&eventName=\"牛肉涨价了\""))
                .andExpect(status().isOk());
        mockMvc.perform(get("/rs/list"))
                .andExpect(jsonPath("$", hasSize(3)))
                .andExpect(jsonPath("$[0].eventName", is("第一条事件")))
                ...
                .andExpect(jsonPath("$[1].eventName", is("第二条事件")))
                .andExpect(jsonPath("$[1].keyWord", is("无标签")))
                .andExpect(jsonPath("$[2].eventName", is("牛肉涨价了")))
                .andExpect(jsonPath("$[2].keyWord", is("经济")))
                .andExpect(status().isOk());
        mockMvc.perform(patch("/rs/update?index=1&eventName=\"小学生放假了\"&keyWord=\"社会时事\""))
                .andExpect(status().isOk());
        mockMvc.perform(get("/rs/list"))
                .andExpect(jsonPath("$[0].eventName", is("第一条事件")))
                .andExpect(jsonPath("$[0].keyWord", is("无标签")))
                ...
                .andExpect(status().isOk());
        mockMvc.perform(patch("/rs/update?index=1&keyWord=\"政治\""))
                .andExpect(status().isOk());
        mockMvc.perform(get("/rs/list"))
                .andExpect(jsonPath("$", hasSize(3)))
                .andExpect(jsonPath("$[0].eventName", is("第一条事件")))
